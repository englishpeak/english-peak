...
import { ACADEMIC_TABLES, ensureTeacherProfile, loadAcademicData } from './academic-data.js';
...
async function loadData() {
  ...
  if (state.isAdmin) state.teachers = await query('profiles','id,email,full_name,tier,is_admin',q=>q.eq('tier','teacher'));
