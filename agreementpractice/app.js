const QUESTIONS = [
  ...
  { type:'negative', sentence:'Daniel ___ coffee after 6 p.m.', base:"don't drink", third:"doesn't drink", answer:"doesn't drink", explanation:"Daniel = he, so use doesn't + the base verb: doesn't drink." },
  ...
  { type:'negative', sentence:'My parents ___ much television.', base:"don't watch", third:"doesn't watch", answer:"don't watch", explanation:"My parents = they, so use don't + the base verb: don't watch." },
  ...
  { type:'negative', sentence:'The software ___ properly on older laptops.', base:"don't work", third:"doesn't work", answer:"doesn't work", explanation:"The software = it, so use doesn't + the base verb: doesn't work." },
  ...
  { type:'negative', sentence:'Our marketing team ___ every idea immediately.', base:"don't approve", third:"doesn't approve", answer:"doesn't approve", explanation:"Our marketing team is singular here, so use doesn't + the base verb: doesn't approve." },
  ...
  { type:'negative', sentence:'We ___ personal calls during client meetings.', base:"don't take", third:"doesn't take", answer:"don't take", explanation:"With we, use don't + the base verb: don't take." },
  ...
  { type:'negative', sentence:'Marcus ___ his work email at weekends.', base:"don't check", third:"doesn't check", answer:"doesn't check", explanation:"Marcus = he, so use doesn't + the base verb: doesn't check." },
  ...
  { type:'negative', sentence:'They ___ the same view on flexible working hours.', base:"don't share", third:"doesn't share", answer:"don't share", explanation:"With they, use don't + the base verb: don't share." },
  ...
  { type:'negative', sentence:'Priya ___ to impress people with job titles.', base:"don't try", third:"doesn't try", answer:"doesn't try", explanation:"Priya = she, so use doesn't + the base verb: doesn't try." },
  ...
  { type:'negative', sentence:'I ___ every notification as soon as it appears.', base:"don't open", third:"doesn't open", answer:"don't open", explanation:"With I, use don't + the base verb: don't open." },
  ...
  { type:'negative', sentence:'The repair shop ___ devices without proof of purchase.', base:"don't fix", third:"doesn't fix", answer:"doesn't fix", explanation:"The repair shop = it, so use doesn't + the base verb: doesn't fix." },
  ...
  { type:'negative', sentence:'The last bus ___ the airport terminal after midnight.', base:"don't pass", third:"doesn't pass", answer:"doesn't pass", explanation:"The last bus = it, so use doesn't + the base verb: doesn't pass." },
  ...
  { type:'negative', sentence:'You ___ any important details when you tell a story.', base:"don't miss", third:"doesn't miss", answer:"don't miss", explanation:"With you, use don't + the base verb: don't miss." },
  ...
  { type:'negative', sentence:'Aisha ___ client data on her personal computer.', base:"don't store", third:"doesn't store", answer:"doesn't store", explanation:"Aisha = she, so use doesn't + the base verb: doesn't store." },
  ...
  { type:'negative', sentence:'These headphones ___ much when you move around.', base:"don't move", third:"doesn't move", answer:"don't move", explanation:"These headphones = they, so use don't + the base verb: don't move." },
  ...
  { type:'negative', sentence:'She ___ her day until she reviews the team calendar.', base:"don't plan", third:"doesn't plan", answer:"doesn't plan", explanation:"With she, use doesn't + the base verb: doesn't plan." },
